...
describe Admin::ContentController do
  ...
  describe 'with admin connection' do
    ...
    describe 'edit action' do
      ...
      #I added this
      it "should have varialbe @current_user_is_admin ==true" do
        article=@article
        post :edit, 'id'=>article.id, 'article' => {:body => body, :text_filter => 'textile'}
        assigns(:current_user_is_admin).should == true
      end
    ...
    describe 'merge_with action' do
      ...
      it "should change the number of articles" do
        lambda {
          get :merge_with, 'id' => @article.id, 'merge_with' => @second_article.id
        }.should change(Article, :count)
      end

      it "should render to the merged aticle view" do
        get :merge_with, :id=> @article.id, 'merge_with' => @second_article.id
  ...
  describe 'with publisher connection' do
    ...
    describe 'edit action' do
      ...
      #I added this
      it "shoud have @current_user_is_admin== false" do
        article=@article
        post :edit, 'id'=>article.id, 'article' => {:body => body, :text_filter => 'textile'}
        assigns(:current_user_is_admin).should == false
      end
